      ...
      <Container style={{ width: "100%" }}>
        ...
        >
          ...
          >
            ...
            <Avatar.Image
              size={32}
              source={{
                uri: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80",
              }}
            />
          </View>
        </TouchableOpacity>
        <DashboardContainer>
          <MainText style={{ fontSize: 20 }}>
            Hello, <OrangeText>Aditya</OrangeText>
          </MainText>
